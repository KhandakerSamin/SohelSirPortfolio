  ...
  const industrialExperiences = [
    {
      ...
      status: "current",
      responsibilities: [
        "Providing expert consultation on AI/ML implementation strategies and solutions",
        "Designing and architecting intelligent systems for business process automation",
        "Developing custom machine learning models for client-specific requirements",
        "Conducting AI readiness assessments and technology roadmap planning",
        "Leading proof-of-concept projects for AI-driven innovations",
        "Training client teams on AI technologies and best practices",
        "Integrating cutting-edge AI solutions including LLMs and Computer Vision",
      ],
      skills: [
        "AI Strategy",
        "Machine Learning",
