const Footer = () => {
  ...
  const socialLinks = [
    {
      name: "LinkedIn",
      href: "https://www.linkedin.com/in/md-shohel-arman-shuvo1/",
      icon: (
    ...
    {
      name: "GitHub",
      href: "https://github.com/shohel1arman",
      icon: (
        <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
    ...
    <footer className="bg-card border-t border-border">
      <div className="max-w-7xl mx-auto px-6 lg:px-8 py-12">
        <div className="grid md:grid-cols-3 gap-8">
          ...
          <div>
            ...
            <div className="space-y-2">
              ...
              <a href="/skills" className="block text-muted-foreground hover:text-foreground transition-colors text-sm">
                Skills
              </a>
              <a
                href="/contact"
        ...
        <div className="border-t border-border mt-8 pt-8 text-center">
          <p className="text-muted-foreground text-sm">© {currentYear} Md. Shohel Arman. All rights reserved.</p>
        </div>
      </div>
    </footer>
  )
